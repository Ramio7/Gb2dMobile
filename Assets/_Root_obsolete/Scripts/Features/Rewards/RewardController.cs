...
namespace Rewards
{
    ...
    {
        private readonly ResourcePath _resourcePath = new("Prefabs/Ui/RewardsMenu");
        ...
        public RewardController(Transform uiContainer, ProfilePlayer profilePlayer)
        {
            _profilePlayer = profilePlayer;
            _view = LoadView(uiContainer);
